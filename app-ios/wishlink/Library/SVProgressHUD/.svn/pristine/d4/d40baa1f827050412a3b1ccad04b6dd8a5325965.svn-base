...
+ (void)showWithStatusWithBlack:(NSString*)status
{
     [self showProgressWithBlack:SVProgressHUDUndefinedProgress status:status];
}
...
+ (void)showProgressWithBlack:(float)progress status:(NSString *)status {
    [self sharedView];
...
+ (void)showInfoWithStatusWithBlack:(NSString *)string {
    [self sharedView];
    [self showSuccessWithStatus:string maskType:SVProgressHUDMaskTypeBlack];
}
...
+ (void)showSuccessWithStatusWithBlack:(NSString*)string
{
    [self sharedView];
    [self showSuccessWithStatus:string maskType:SVProgressHUDMaskTypeBlack];
}
...
+ (void)showErrorWithStatusWithBlack:(NSString*)string
{
    [self sharedView];
    [self showErrorWithStatus:string maskType:SVProgressHUDMaskTypeBlack];
}
