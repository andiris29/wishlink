...
#define APP_ID          @"wx7d2407c862aeda7b"               //APPID
#define APP_SECRET      @"8f4bb1d0bf4d71024b9d11825e80c771" //appsecret
//商户号，填写商户对应参数
#define MCH_ID          @"1273718601"
//商户API密钥，填写相应参数
#define PARTNER_ID      @"1qaz2wsx3edc4rfv1234qwerasdfzxcv"
//支付结果回调页面
#define NOTIFY_URL      @"http://121.41.162.102/wishlink-payment/wechat/callback"
//获取服务器端支付数据地址（商户自定义）
...
//初始化函数
-(BOOL) initWith:(NSString *)app_id mch_id:(NSString *)mch_id;
-(NSString *) getDebugifo;
-(long) getLasterrCode;
//设置商户密钥
-(void) setKey:(NSString *)key;
